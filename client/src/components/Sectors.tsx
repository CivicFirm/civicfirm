 ...
 * 11 sectors — aligned with Our Approach page.
 */
      ...
      <div className="container">
        ...
        <div ref={headRef} className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12 md:mb-16">
          <div className="max-w-2xl">
            ...
            >
              Trusted across{" "}
              <span className="text-primary">12 sectors</span>{" "}
              in North America.
            </motion.h2>
          </div>
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              We work with any organization that takes what it does seriously. Get in touch to discuss your project.
            </p>
          </div>
          <a
            href="/contact"
