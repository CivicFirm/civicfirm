      ...
      <div className="container relative z-10 pt-28 pb-20 md:pt-36 md:pb-28">
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="text-[#5cb85c]">that take what they do</span> seriously.
          </motion.h1>
          ...
          >
            {trustBadges.map((badge) => (
              ...
              >
                <svg className="w-3.5 h-3.5 text-[#5cb85c] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
